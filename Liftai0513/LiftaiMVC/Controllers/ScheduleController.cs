...
namespace LiftaiMVC.Controllers
{
    public class ScheduleController : Controller
    {
        ...
        public ActionResult SchedulePreview()
        {
            ...
            //Models.Schedule s = new Schedule(DateTime.Today, DateTime.UtcNow.AddHours(-2), DateTime.UtcNow.AddHours(6), 0);
            //db.Schedules.Add(s);
            //db.SaveChanges();
            ...
            try
            {
                schedule = db.Schedules.First(x => x.HandymanId == 0 && x.Date.Equals(DateTime.Today));
            }
            catch
            {
                schedule = null;
